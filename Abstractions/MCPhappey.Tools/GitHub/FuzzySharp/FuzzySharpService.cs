...
public static class FuzzySharpService
{
    ...
    public static async Task<double> Fuzzy_Ratio(
    ...
    public static async Task<double> Fuzzy_PartialRatio(string a, string b) =>
    ...
    public static async Task<double> Fuzzy_TokenSortRatio(string a, string b) =>
    ...
    public static async Task<double> Fuzzy_PartialTokenSortRatio(string a, string b) =>
    ...
    public static async Task<double> Fuzzy_TokenSetRatio(string a, string b) =>
    ...
    public static async Task<double> Fuzzy_PartialTokenSetRatio(string a, string b) =>
    ...
    public static async Task<double> Fuzzy_TokenInitialismRatio(string a, string b) =>
    ...
    public static async Task<double> Fuzzy_PartialTokenInitialismRatio(string a, string b) =>
    ...
    public static async Task<double> Fuzzy_TokenAbbreviationRatio(
        string a,
        string b,
    ...
    public static async Task<double> Fuzzy_PartialTokenAbbreviationRatio(
        string a,
        string b,
        [Description("'Full' or 'None' preprocessing")] string preprocess = "Full")
    {
    ...
    public static async Task<double> Fuzzy_WeightedRatio(string a, string b) =>
