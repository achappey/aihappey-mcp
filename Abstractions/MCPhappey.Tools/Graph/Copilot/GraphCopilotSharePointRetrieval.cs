...
public static class GraphCopilotSharePointRetrieval
{
    [Description("Retrieve Microsoft 365 Copilot semantic search results using the Microsoft Graph SharePoint Retrieval API.")]
    [McpServerTool(
        Title = "Microsoft 365 Copilot SharePoint Retrieval",
        Name = "graph_copilot_sharepoint_retrieval",
        OpenWorld = false,
        ReadOnly = true)]
    public static async Task<CallToolResult?> Graph_CopilotSharePointRetrieval(
