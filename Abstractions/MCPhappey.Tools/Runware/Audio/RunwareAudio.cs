...
public static class RunwareAudio
{
    ...
    public static async Task<CallToolResult?> RunwareAudio_Create(
           ...
           [Description("Audio duration in seconds (10–300).")] float duration = 30,
           ...
           [Description("Audio sample rate in Hz (8000–48000).")] int sampleRate = 44100,
           [Description("Audio bitrate in kbps (32–320).")] int bitrate = 128,
           ...
           => await requestContext.WithExceptionCheck(async () =>
               await requestContext.WithStructuredContent(async () =>
               {
                   ...
                   // 🎧 4. Return raw JSON for UI or toolchain processing
