...
public sealed class PDFDataClient
{
    ...
    public PDFDataClient(HttpClient client, PDFDataSettings settings)
    {
        _client = client;
        _client.BaseAddress ??= new Uri("https://pdfdata.io/");
...
public sealed class PDFDataSettings
{
